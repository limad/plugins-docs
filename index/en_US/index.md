...
<div class="plugin-card">
	...
	<p class="plugin-card__desc">Turns Jeedom into an MCP (Model Context Protocol) server to control your home automation with Claude Desktop, Cursor and any compatible AI client.</p>
...
<div class="plugin-card">
	<a class="plugin-card__header" href="{{site.baseurl}}/plugin-ai_assistant/{{page.lang}}">
	<img src="{{site.market}}/filestore/market/plugin/images/ai_assistant_icon.png" alt="ai_assistant">
	<div>
		<h2 class="plugin-card__name">AI Assistant</h2>
		<span class="plugin-card__id">ai_assistant</span>
	</div>
	</a>
	<p class="plugin-card__desc">AI chat interface for Jeedom with three roles: conversational agent, specialized Jeedom assistant, and MCP bridge (Model Context Protocol) connecting your AI model to your home automation.</p>
	<div class="plugin-card__links">
	<a href="{{site.baseurl}}/plugin-ai_assistant/{{page.lang}}">Documentation</a>
	<a href="{{site.baseurl}}/plugin-ai_assistant/{{page.lang}}/changelog">Changelog</a>
	<a href="{{site.market}}/index.php?v=d&plugin_id=4636" target="_blank" rel="noopener">Market ↗</a>
	</div>
</div>
...
<div class="plugin-card">
	...
	<p class="plugin-card__desc">Integration of Netatmo thermostats, valves and OpenTherm thermostat into Jeedom. Data acquisition and action execution via API and webhooks. Compatible with the mobile plugin.</p>
	<div class="plugin-card__links">
...
<div class="plugin-card">
	...
	<div>
		<h2 class="plugin-card__name">Netatmo Security</h2>
		<span class="plugin-card__id">netatmoSecurity</span>
	</div>
	</a>
	<p class="plugin-card__desc">Manage Netatmo Security devices and cameras. No unwanted emails. Connection via API and/or locally.</p>
	<div class="plugin-card__links">
...
<div class="plugin-card">
	...
	<p class="plugin-card__desc">Integration of Vaillant/Saunier-Duval thermostats (senso/MiSet/MiPro Sense) with VR92x or MiLink V3 gateway. Data acquisition and actions via API.</p>
	<div class="plugin-card__links">
...
<div class="plugin-card">
	...
	<p class="plugin-card__desc">Integration of Vaillant/Saunier-Duval thermostats with VR92x or MiLink V3 gateway (sensoApp/MiControl). Setpoints and schedules via API.</p>
	<div class="plugin-card__links">
...
<div class="plugin-card">
	...
	<p class="plugin-card__desc">Control the MiGo/eRelax thermostat from Jeedom.</p>
	<div class="plugin-card__links">
...
<div class="plugin-card">
	...
	<p class="plugin-card__desc">Alexa Premium plugin for Jeedom.</p>
	<div class="plugin-card__links">
...
<div class="plugin-card">
	...
	<p class="plugin-card__desc">Control Amazon Music on your Alexa devices from Jeedom: playback, volume, playlists, TuneIn radio, equalizer and playback transfer between devices.</p>
	<div class="plugin-card__links">
...
<div class="plugin-card">
	...
	<p class="plugin-card__desc">Control your SFR/Neuf Box from Jeedom.</p>
	<div class="plugin-card__links">
...
<div class="plugin-card">
	...
	<p class="plugin-card__desc">Control D-Link DSP-W215 smart plugs: ON/OFF state, instant power (W), cumulative consumption.</p>
	<div class="plugin-card__links">
...
<div class="plugin-card">
	...
	<p class="plugin-card__desc">GRDF Connect integration for gas consumption tracking.</p>
	<div class="plugin-card__links">
...
<div class="plugin-card">
	...
	<p class="plugin-card__desc">HelloWatt plugin for energy tracking.</p>
	<div class="plugin-card__links">
...
<div class="plugin-card">
	...
	<p class="plugin-card__desc">Supervision and monitoring of Modbus devices.</p>
	<div class="plugin-card__links">
...
<div class="plugin-card">
	...
	<p class="plugin-card__desc">Integration of the Comap filtration unit (Proteo/Komeo).</p>
	<div class="plugin-card__links">
...
<div class="plugin-card">
	...
	<p class="plugin-card__desc">Control D-Link DCH-S150 motion sensors from Jeedom.</p>
	<div class="plugin-card__links">
...
<div class="plugin-card">
	...
	<p class="plugin-card__desc">ebus plugin for home automation bus integration.</p>
	<div class="plugin-card__links">
